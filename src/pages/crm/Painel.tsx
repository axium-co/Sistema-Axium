...
const CRMDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header section */}
      <div className="mb-10">
        <h1 className="text-4xl font-black text-black tracking-tight mb-2">Painel de Vendas</h1>
        <p className="text-slate-500 text-sm">Monitoramento em tempo real do seu funil de vendas.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-10">
        {stats.map((stat, idx) => {
          ...
          return (
            <div key={idx} className="bg-white border border-slate-200 rounded-xl p-5 hover:border-black transition-all shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-8 h-8 rounded-lg bg-slate-100 flex items-center justify-center">
                  <Icon size={16} className="text-black" />
                </div>
                <p className="text-slate-500 text-[11px] font-bold uppercase tracking-widest leading-none">{stat.title}</p>
              </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
        <div className="mb-8">
          <h2 className="text-xl font-bold text-black mb-1">Visão Geral do Pipeline</h2>
          <p className="text-slate-400 text-xs uppercase font-bold tracking-widest">Distribuição de leads por etapa</p>
        </div>
